...
import InternationalExperienceSection from "@/components/section/international-experience-section";
              ...
              <BlurFade key={education.school} delay={BLUR_FADE_DELAY * 8 + index * 0.05}>
                ...
                >
                  <div className="flex items-center gap-x-3 flex-1 min-w-0">
                    {education.logoUrl ? (
                      <div className="size-8 md:size-10 p-2 border rounded-full shadow ring-2 ring-border overflow-hidden object-contain flex-none">
                        <img
